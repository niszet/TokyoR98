...
-   作図してドキュメントに手で貼り付け... 表を整形して手で張り付け...

    -   データが差し変わった/更新された時に同じ操作をしないといけない。
...
-   R言語で書かれたプログラムや分析の結果（図や表、プログラムのコード自体も！）をドキュメントに埋め込んで生成できる。
...
-   ドキュメント部分はMarkdownと呼ばれる記法を使って記述する
    -   元々はhtmlを簡便に書くための記法
-   最近はいろいろなサービスで使われている（ただしそれぞれに方言がある...）
...
-   Markdownで構造化を意識して書くと、自然とカッチリした文章になり易い
...
-   `R Markdown`は最初から全体を追っていくのは大変
    ...
    -   これに分析方法・モデリングや文章の書き方など考えることが沢山ある
...
-   ここで使用するファイルはGitHub上にもあるので、手元でも試してみてください。
...
## Global Options-R Markdown-Advanced
...
## Global setting-R Markdown-Visual
...
## Global setting-R Markdown-Citations
...
## Global Options-R Markdown-Quarto
